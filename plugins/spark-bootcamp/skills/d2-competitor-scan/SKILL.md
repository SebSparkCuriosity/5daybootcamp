...
## Before you start
Read `02-market/market-map.md` (your chosen segment and pain) and `00-prework/interview-target-spec.md` if it exists. Ask before you hunt (5 minutes): who did the interviewees name, who does the founder fear losing to, what would the buyer do instead of paying anyone, and is there a proven model already winning this job elsewhere that you would be localising rather than inventing? Then research. Never invent numbers: every cell is a fact from the rival's own site (cite the URL) or a cell marked "assumption".
